   ...
   protected static void CustomerMenuDisplay(){
      ...
      do {
         ...
         for(int count = 0; count <= 3; count++){
            num = num + 1;
            System.out.println(num + ". " + packages[count].getPackageName() + " " + packages[count].getPrice());
         }//for
      ...
      KwikNKleenCarWash.Sales.totalPurchasesPerPackage(packageOption);
      ...
      if (member == 'Y') {
         ...
         newMember = new KwikNKleenCarWash.MemberCustomer(customerName, packageChoice,
         ...
         KwikNKleenCarWash.Sales.setMemberPackageCount(1);
      }//if
      else
      {
         if (member == 'N')
         {
            ...
            newNonMember = new KwikNKleenCarWash.NonMemberCustomer(customerName, packageChoice,
                    packages[packageOption-1].getPrice());
            //use method to print details to console
            newNonMember.printCustomerInfo();
            //counting the amount of times NonMembers purchased a package
            KwikNKleenCarWash.Sales.setNonMemberPackageCount(1);
         }//if
      }//else
